...
HTML utilise des **balises** pour construire des pages web. Trouves ce code HTML à la ligne 8:
...
Une autre balise que tu peux avoir repéré est `<b>`, qui signifie **gras** (bold):
