...
Если у вас нет аккаунта Trinket, то нажми клавишу со стрелкой **down** (вниз), затем нажми на **Link (Ссылка)**. Это даст вам ссылку, которую вы можете сохранить и вернуться к ней позже. Тебе придётся делать это после каждого созданного изменения, так как ссылка будет меняться после каждого из них!
